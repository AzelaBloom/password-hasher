...
function hHash($password_plain, $salt = "LxzLSC9Xactza23u6+TUv-NbMs%H=4PsLveHyUW9S*zcQp*Uyt"){
...
function hVerify($password_plain, $password_hash, $salt = "LxzLSC9Xactza23u6+TUv-NbMs%H=4PsLveHyUW9S*zcQp*Uyt"){
    $hashing = hHash($password_plain, $salt);
